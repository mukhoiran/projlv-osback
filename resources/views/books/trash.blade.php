...
@section("content-title") Trashed Books @endsection
              ...
              @foreach($books as $book)
                <tr>
                  ...
                  <td>
                    ...
                    <form class="d-inline" action="{{route('books.delete-permanent', ['id' => $category->id])}}" method="POST" onsubmit="return confirm('Delete this category permanently?')">
                      @csrf
